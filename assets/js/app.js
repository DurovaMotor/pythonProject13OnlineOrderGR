(function () {
  var CART_KEY = "hightac-gr150-cart-v1";
  var SUBMISSION_KEY = "hightac-gr150-last-submission-v1";
  var LANG_KEY = "hightac-gr150-language-v1";
  var DEFAULT_LANG = "fr";
  ...
  function getCatalog() {
    ...
    return {
      model: {
        name: "SYMPHONY ST",
        motorPicture: "Database/MotorPictures/SYMPHONY ST.png"
      },
      parts: []
    };
  }
  ...
  function submitCart() {
    ...
    var modelName = state.catalog.model.name || "SYMPHONY ST";
